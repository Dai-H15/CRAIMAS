...
class CustomUser(AbstractUser):
    ...
    infomation_last_checked = models.DateTimeField(null=False, blank=False, default=datetime.datetime.strptime("2020-01-01 00:00:00", "%Y-%m-%d %H:%M:%S"), verbose_name="お知らせ最終確認日時")
