...
class AdoptionForm(forms.ModelForm):
    class Meta:
        model = Adoption
        fields = ("occupation", "place", "n_adopters", "n_enrollment", "from_url", "salary", "a_year")
        labels = {
            "occupation": "採用職種",
            "place": "勤務予定地",
            "n_adopters": "採用予定人数",
...
class SearchForm_corpnum(forms.Form):
    ...
    founded_year = forms.IntegerField(label="設立年", required=False)
...
class InterviewForm(forms.ModelForm):
    ...
    class Meta:
        model = Interview
        fields = ("RegistID", "InterviewID", "title", "tag", "date", "interviewer", "zipcode", "place", "Event_URL", "aspire", "reason", "want_to", "note", "summary", "review")
        labels = {
                    "RegistID": "登録セットキー",
